...
//       listItem.classList.add("doctor-box");
...
//       doctorPhoto.alt = doctor.name;

//       const doctorName = document.createElement("p");
//       doctorName.classList.add("doctor-name");
//       doctorName.textContent = doctor.name;

//       const doctorRole = document.createElement("p");
//       doctorRole.classList.add("doctor-role");
//       doctorRole.textContent = doctor.role;

//       const doctorExperience = document.createElement("div");
//       doctorExperience.classList.add("experience");
//       const experienceIcon = document.createElement("img");
//       experienceIcon.classList.add("doctor-exicon");
//       experienceIcon.src = "../img/experience.png";
//       experienceIcon.alt = "Experience Icon";
//       const experienceText = document.createElement("p");
//       experienceText.textContent = doctor.experience;
//       doctorExperience.appendChild(experienceIcon);
//       doctorExperience.appendChild(experienceText);

//       const doctorTimetable = document.createElement("div");
//       doctorTimetable.classList.add("timetable");
//       const timetableIcon = document.createElement("img");
//       timetableIcon.classList.add("doctor-timeicon");
//       timetableIcon.src = "../img/timetable.png";
//       timetableIcon.alt = "Timetable Icon";
//       const timetableText = document.createElement("p");
//       timetableText.textContent = doctor.timetable;
//       doctorTimetable.appendChild(timetableIcon);
//       doctorTimetable.appendChild(timetableText);

//       // Tambahkan elemen-elemen ke dalam listItem
//       listItem.appendChild(doctorPhoto);
//       listItem.appendChild(doctorName);
//       listItem.appendChild(doctorRole);
//       listItem.appendChild(doctorExperience);
//       listItem.appendChild(doctorTimetable);

//       // Tambahkan listItem ke dalam doctorList
